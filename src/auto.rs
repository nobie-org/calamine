    ...
    RS: std::io::Read + std::io::Seek,
{
    ...
    fn worksheet_row_definitions(&mut self, name: &str) -> Result<RowDefinitions, Self::Error> {
        match self {
            Sheets::Xlsx(ref mut e) => e.worksheet_row_definitions(name).map_err(Error::Xlsx),
